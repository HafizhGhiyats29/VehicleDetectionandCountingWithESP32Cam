...
print ("no of cars" )
print (count)
firebase = firebase.FirebaseApplication('https://esp32-bc425-default-rtdb.firebaseio.com/')
data = {'Cars': 'hafizh'}
result = firebase.put('https://esp32-bc425-default-rtdb.firebaseio.com/customer',data)
print(result)
